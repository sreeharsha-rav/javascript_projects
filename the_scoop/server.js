...
// database object containing all stored model instances -> user, article, comments
let database = {
  users: {},
  articles: {},
  nextArticleId: 1,
...
// function to process GET request for getting user
...
// function to process POST request for creating user
...
// function to process GET request for getting several articles
...
// function to process GET request for getting a specific article
...
// function to process POST request for creating an article
...
// function to process PUT request for updating an article
...
// function to process DELETE reqeust for deleting an article
...
// function to process PUT request for upvoting an article
...
// function to process PUT request for downvoting an article
...
// function to process POST request for creating a comment
...
// function to process PUT request for updating a comment
...
// function to process DELETE request for deleting a comment
...
// function to process PUT request for upvoting a comment
...
// function to process PUT request for downvoting a comment
...
// helper function for downvoting
...
// get modules for setting up server and processing web addresses
const http = require('http');
const url = require('url');

const port = process.env.PORT || 4000;  // define port or default to 4001
...
// helper function to process url -> route
...
// set up server with requestHandler callback
const server = http.createServer(requestHandler);
// start the server and listen for incoming requests on given port
server.listen(port, (err) => {
  // handle error during server startup
  if (err) {
